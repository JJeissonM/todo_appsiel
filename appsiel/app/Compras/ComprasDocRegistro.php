...
class ComprasDocRegistro extends Model
{
    ...
    public $encabezado_tabla = ['<i style="font-size: 20px;" class="fa fa-check-square-o"></i>', 'Encabezado documento', 'Producto', 'Precio', 'Cantidad', 'Total', 'Base IVA', 'Tasa IVA', 'Total IVA', 'Cantidad recibida'];
