...
class ComprasDocRegistro extends Model
{
	...
	protected $fillable = ['base_retencion', 'compras_doc_encabezado_id', 'inv_doc_registro_id', 'inv_motivo_id', 'inv_producto_id', 'precio_unitario', 'cantidad', 'precio_total', 'base_impuesto', 'tasa_impuesto', 'valor_impuesto', 'tasa_descuento', 'valor_total_descuento', 'contab_retencion_id', 'tasa_retencion', 'valor_retencion', 'retencion_fuente_concepto_anual_id', 'retencion_fuente_codigo', 'cantidad_recibida', 'cantidad_devuelta', 'creado_por', 'modificado_por', 'estado', 'xml_producto', 'xml_codigo', 'xml_cantidad', 'xml_precio_unitario'];

	// En compras los impuestos se calculan con base en el costo_unitario (precio_compra)
	public $campos_invisibles_linea_registro = ['inv_motivo_id','inv_bodega_id','inv_producto_id','costo_unitario','precio_unitario','base_impuesto','tasa_impuesto','valor_impuesto','cantidad','costo_total','precio_total', 'tasa_descuento', 'valor_total_descuento', 'contab_retencion_id', 'tasa_retencion', 'valor_retencion', 'retencion_fuente_concepto_anual_id', 'retencion_fuente_codigo']; // 18 campos
    ...
    public static function get_registros_impresion( $doc_encabezado_id )
    {
        ...
        return ComprasDocRegistro::where('compras_doc_registros.compras_doc_encabezado_id', $doc_encabezado_id)
                    ...
                    ->select(
                                ...
                                'compras_doc_registros.xml_cantidad',
                                'compras_doc_registros.xml_precio_unitario',
