...
class NovedadTnl extends Model
{
	...
	*/
	...
	protected $casts = [
		'cantidad_dias_tnl' => 'float',
		'cantidad_horas_tnl' => 'float',
		'valor_a_pagar_eps' => 'float',
		'valor_a_pagar_arl' => 'float',
		'valor_a_pagar_afp' => 'float',
		'valor_a_pagar_empresa' => 'float',
		'cantidad_dias_amortizados' => 'float',
		'cantidad_dias_pendientes_amortizar' => 'float',
	];
