...
class DocumentosAbonos extends Model
{
    ...
    public $encabezado_tabla = ['<i style="font-size: 20px;" class="fa fa-check-square-o"></i>', 'Proveedor', 'Documento Abono', 'Fecha', 'Documento de CxP', 'Valor abono'];
    ...
    public static function consultar_registros($nro_registros)
    {
        return DocumentosAbonos::leftJoin('core_tipos_docs_apps', 'core_tipos_docs_apps.id', '=', 'cxp_documentos_abonos.core_tipo_doc_app_id')
            ...
            ->orderBy('cxp_documentos_abonos.created_at', 'DESC')
