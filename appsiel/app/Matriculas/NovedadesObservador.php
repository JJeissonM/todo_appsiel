...
class NovedadesObservador extends Model
{
    ...
    public $encabezado_tabla = ['Estudiante','Periodo','Fecha novedad','Tipo novedad','Descripción','Creado por','Acción'];
    ...
    public static function consultar_registros()
    {
        return NovedadesObservador::leftJoin('sga_estudiantes', 'sga_estudiantes.id', '=', 'sga_novedades_observador.id_estudiante')
                            ...
                            ->select( DB::raw( 'CONCAT(core_terceros.apellido1," ",core_terceros.apellido2," ",core_terceros.nombre1," ",core_terceros.otros_nombres) AS campo1' ),
