...
class EntradaCompras extends InvDocEncabezado
{
    ...
    public static function consultar_registros($nro_registros, $search)
    {
        ...
        $registros = EntradaCompras::leftJoin('core_tipos_docs_apps', 'core_tipos_docs_apps.id', '=', 'inv_doc_encabezados.core_tipo_doc_app_id')
            ...
            ->orWhere('CONCAT(core_terceros.nombre1," ",core_terceros.otros_nombres," ",core_terceros.apellido1," ",core_terceros.apellido2," ",core_terceros.razon_social)', "LIKE", "%$search%")
