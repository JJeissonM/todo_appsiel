...
class InvTransferenciaMercancia extends InvDocEncabezado
{
    ...
    public $encabezado_tabla = ['<i style="font-size: 20px;" class="fa fa-check-square-o"></i>', 'Fecha', 'Documento', 'Bodega', 'Tercero', 'Detalle', 'Doc. Soporte', 'Estado'];
        ...
        if ( $search == '' )
        {
            return InvTransferenciaMercancia::leftJoin('core_tipos_docs_apps', 'core_tipos_docs_apps.id', '=', 'inv_doc_encabezados.core_tipo_doc_app_id')
                                        ...
                                        ->select(
                                            ...
                                            'inv_doc_encabezados.documento_soporte AS campo6',
                                            'inv_doc_encabezados.estado AS campo7',
                                            'inv_doc_encabezados.id AS campo8'
                                        )
