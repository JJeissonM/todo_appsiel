...
class InvEntradaAlmacen extends InvDocEncabezado
{
    ...
    public static function consultar_registros($nro_registros, $search)
    {
        ...
        return InvEntradaAlmacen::leftJoin('core_tipos_docs_apps', 'core_tipos_docs_apps.id', '=', 'inv_doc_encabezados.core_tipo_doc_app_id')
    ...
    {
        return "LISTADO DE ENTRADAS A ALMACEN";
    }
}
