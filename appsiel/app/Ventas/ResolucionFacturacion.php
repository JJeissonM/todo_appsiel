...
class ResolucionFacturacion extends Model
{
	...
	public $encabezado_tabla = ['Empresa', 'Tipo de documento', 'Prefijo', 'Número Resolución', 'Número desde', 'Número hasta', 'Fecha expedición', 'Fecha expiración', 'Modalidad', 'Tipo solicitud', 'Estado', 'Acción'];
