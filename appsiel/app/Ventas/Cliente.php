...
class Cliente extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::saving(function ($cliente) {
            if (!static::validInvBodegaId($cliente->inv_bodega_id)) {
                $cliente->inv_bodega_id = static::getDefaultInvBodegaId();
            }
        });
    }
    ...
    public static function getDefaultInvBodegaId()
    {
        ...
        if ($empresa_id <= 0 && Schema::hasTable('core_empresas')) {
    ...
    public static function validInvBodegaId($inv_bodega_id, $empresa_id = 0)
    {
        ...
        if ((int)$empresa_id <= 0 && Auth::check()) {
            $empresa_id = (int)Auth::user()->empresa_id;
        }
    ...
    {
        return $this->prepararCampoBodegaCliente($lista_campos);
    }

    public function get_campos_adicionales_edit($lista_campos, $registro)
    {
        return $this->prepararCampoBodegaCliente($lista_campos, $registro->inv_bodega_id);
    }

    protected function prepararCampoBodegaCliente($lista_campos, $inv_bodega_id = null)
    {
