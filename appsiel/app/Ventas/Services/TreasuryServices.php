...
class TreasuryServices
{
    public function create_account_receivable_payment_from_invoice(VtasDocEncabezado $account_receivable_document_header,$payment,$payment_methods_lines)
    {
        ...
        $data['document_lines'] = $this->get_json_string_document_lines($payment_methods_lines);
    ...
    {
        // Algunos de estos campos deben desaparecer en el encabezado de documentos de Tesoreria
    ...
    public function get_json_string_document_lines($payment_methods_lines)
    {
        /* 
        ...
        */
        ...
        $campo_lineas_recaudos = $registros_medio_pago->depurar_tabla_registros_medios_recaudos( $payment_methods_lines );        
