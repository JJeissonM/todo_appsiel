...
class VentaController extends TransaccionController
{
    ...
    */
    ...
    public function show($id)
    {
        ...
        $doc_encabezado->documento_transaccion_prefijo_consecutivo = $print_service->get_documento_transaccion_prefijo_consecutivo( $doc_encabezado );
    ...
    */
    ...
    public function consultar_clientes()
    {
        ...
        if ( Input::get('enlace_tipo_boton') == 'true' ) {
            $html .= '<div id="btn_crear_nuevo_registro" class="list-group-item list-group-item-info btn" data-modelo_id="'.$modelo_id.'" > + Crear nuevo </div>';
        }else{
