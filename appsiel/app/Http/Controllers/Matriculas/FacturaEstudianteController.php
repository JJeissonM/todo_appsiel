...
class FacturaEstudianteController extends TransaccionController
{
    ...
    */
    public static function crear_registros_documento( Request $request, $doc_encabezado, array $lineas_registros )
    {
        ...
        for ($i=0; $i < $cantidad_registros; $i++) 
        {
            ...
            FacturaEstudianteController::contabilizar_movimiento_credito( $datos + $linea_datos, $detalle_operacion );
        ...
        // Cartera ó Caja (DB)
        FacturaEstudianteController::contabilizar_movimiento_debito( $forma_pago, $datos + $linea_datos, $total_documento, $detalle_operacion );

        // Crear registro del pago: cuenta por cobrar(cartera) o recaudo
        FacturaEstudianteController::crear_registro_pago( $forma_pago, $datos + $linea_datos, $total_documento, $detalle_operacion );
    ...
    public static function crear_registro_pago( $forma_pago, $datos, $total_documento, $detalle_operacion )
    {
        ...
        */
        ...
        if ( $forma_pago == 'credito')
        {
            $datos['modelo_referencia_tercero_index'] = 'App\Matriculas\Estudiante';
            $datos['referencia_tercero_id'] = $datos['matricula_id'];
    ...
    */
    ...
    public function factura_remision_pendiente( Request $request )
    {
        ...
        FacturaEstudianteController::crear_lineas_registros( $datos, $doc_encabezado, $lineas_registros );
