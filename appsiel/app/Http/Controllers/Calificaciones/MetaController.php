...
class MetaController extends Controller
{
    ...
    public function store(Request $request,$registro_creado)
    {
        ...
        $registro = DB::table('sys_secuencias_codigos')->where([['id_colegio', $id_colegio],
            ['modulo','metas']])->value('consecutivo');
    ...
    {   
        ...
        if ( isset($request->logro_id) ) 
        {
            ...
            $registro = DB::table('sys_secuencias_codigos')->where([['id_colegio', $id_colegio],
                ['modulo','logros']])->value('consecutivo');
            $consecutivo=$registro+1;
    ...
    public function revisar_metas($curso_id, $asignatura_id)
    {
        ...
        $registros = Meta::get_metas( $colegio->id, $curso_id, $asignatura_id );
        ...
        return view('layouts.index', compact('registros','miga_pan','titulo_tabla','encabezado_tabla','url_edit','url_print','url_ver','url_estado','url_eliminar'));
    }
