...
class DocCruceController extends TransaccionController
{
  ...
  public function store(Request $request)
  {
    ...
    for ($i = 0; $i < $cant; $i++) {
      ...
      //dd(  $request->tabla_documentos_a_cancelar, $tabla_documentos_a_cancelar, $tabla_documentos_a_cancelar[$i]);
  ...
  public function revisar_anticipos($tercero_id, $fecha_doc = null)
  {
    ...
    if (Input::get('origen') == 'ventas_pos') {
      return View::make('ventas_pos.componentes.cxc_anticipos', compact('movimiento_cxc', 'vista'));
    }
