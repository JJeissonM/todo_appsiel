...
class ComprobanteEgresoController extends TransaccionController
{
    ...
    public function show($id)
    {
        ...
        $documento_vista2 = View::make('tesoreria.pagos.comprobantes_egreso_vista',compact( 'encabezado_documento', 'empresa', 'vista_impresion' ) )->render();
        ...
        return view( 'tesoreria.pagos.comprobantes_egreso', compact( 'id', 'botones_anterior_siguiente', 'documento_vista2', 'documento_vista', 'id_transaccion', 'miga_pan','doc_encabezado','empresa', 'encabezado_documento') );
    }
    ...
    public function imprimir($id)
    {
        ...
        $view = View::make('tesoreria.pagos.comprobantes_egreso_vista',compact( 'encabezado_documento', 'empresa', 'vista_impresion' ) )->render();
    ...
    public function anular($id)
    {
        ...
        return redirect( 'teso_comprobante_egreso_show/'.$id.'?id='.Input::get('id').'&id_modelo='.Input::get('id_modelo').'&id_transaccion='.Input::get('id_transaccion') )->with('flash_message','Documento de anulado correctamente.');
    }
}