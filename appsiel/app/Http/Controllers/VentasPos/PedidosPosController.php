...
class PedidosPosController extends TransaccionController
{
    ...
    public function edit($id)
    {
        ...
        $lineas_registros = $this->armar_cuerpo_tabla_lineas_registros($registro->lineas_registros, 'edit');
    ...
    public function armar_cuerpo_tabla_lineas_registros($lineas_registros_documento, $origin = '')
    {
        $user = Auth::user();
    ...
    // Carga un pedido para facturarlo
