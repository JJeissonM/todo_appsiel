...
class FrontEndController extends Controller
{
    ...
    {
        // Se verifica que la Aplicación Página Web esté activado
        $estado_pagina_web = Aplicacion::where('app','web')->value('estado');
    ...
    public function old(){
        ...
        //sreturn View::make( 'web.front_end.templates.demo.index', compact('pagina') )->render();
        //}
        ...
        */
        ...
        //return view( 'web.front_end.templates.'.$pagina_plantilla.'.index', compact( 'pagina', 'cadena_secciones' ) );
    }
    ...
    {        
        ...
        if ( $slug == 'galeria_imagenes') 
        {
            ...
            return view('web.front_end.templates.blog.index',compact('pagina', 'empresa','miga_pan','galeria_imagenes'));
            ...
            return view('web.front_end.templates.blog.index',compact('pagina', 'empresa','articulos','el_articulo','miga_pan','galeria_imagenes','categoria'));
        }
    ...
    public function contactenos( Request $request )
    {
        ...
        // El mensaje
        $cuerpo_mensaje = View::make('web.front_end.modulos.contactenos.cuerpo_mensaje',compact('request','empresa'))->render();
    ...
    public function ajax_galeria_imagenes( $carousel_id ){
        ...
        return '<h3>'.$datos_carousel['descripcion'].'</h3>'.View::make( 'web.front_end.modulos.carousel.index',['datos'=>$datos_carousel] );
    }
