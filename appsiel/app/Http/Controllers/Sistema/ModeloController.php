...
class ModeloController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        $id_transaccion = TipoTransaccion::where('core_modelo_id', (int) $id_modelo)->where('estado', 'Activo')->value('id');

        //dd( $id_transaccion );

        // Se le asigna a cada variable url, su valor en el modelo correspondiente
        $variables_url = '?id=' . $id_app . '&id_modelo=' . $id_modelo . '&id_transaccion=' . $id_transaccion;
