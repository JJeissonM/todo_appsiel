...
class Asignatura extends Model
{
    ...
    public static function consultar_registros()
    {
        ...
        $registros = Asignatura::leftJoin('sga_areas','sga_areas.id','=','sga_asignaturas.area_id')->select('sga_asignaturas.id AS campo1', 'sga_areas.descripcion AS campo2', 'sga_asignaturas.descripcion AS campo3', 'sga_asignaturas.abreviatura AS campo4', 'sga_asignaturas.estado AS campo5',
    ...
    public static function asignaturas_calificadas( $curso_id, $periodo_id )
    {
        ...
        return Asignatura::leftJoin('sga_curso_tiene_asignaturas','sga_curso_tiene_asignaturas.asignatura_id','=','sga_asignaturas.id')
                        ...
                        ->where($array_wheres)
                        ->select('sga_asignaturas.id', 'sga_asignaturas.abreviatura', 'sga_asignaturas.descripcion',
                                    'sga_curso_tiene_asignaturas.intensidad_horaria', 'sga_curso_tiene_asignaturas.orden_boletin',
                                    'sga_curso_tiene_asignaturas.maneja_calificacion', 'sga_areas.descripcion as area', 'sga_areas.orden_listados as orden')
