...
class CalificacionAuxiliar extends Model
{
	...
	public static function get_todas_un_estudiante_periodo( $estudiante_id, $periodo_id )
	{
		return CalificacionAuxiliar::leftJoin('sga_asignaturas', 'sga_asignaturas.id', '=', 'sga_calificaciones_auxiliares.id_asignatura')
            ...
            ->select('sga_asignaturas.descripcion AS asignatura','sga_asignaturas.id AS asignatura_id','sga_calificaciones_auxiliares.C1', 'sga_calificaciones_auxiliares.C2', 'sga_calificaciones_auxiliares.C3', 'sga_calificaciones_auxiliares.C4', 'sga_calificaciones_auxiliares.C5', 'sga_calificaciones_auxiliares.C6', 'sga_calificaciones_auxiliares.C7', 'sga_calificaciones_auxiliares.C8', 'sga_calificaciones_auxiliares.C9', 'sga_calificaciones_auxiliares.C10', 'sga_calificaciones_auxiliares.C11', 'sga_calificaciones_auxiliares.C12', 'sga_calificaciones_auxiliares.C13', 'sga_calificaciones_auxiliares.C14', 'sga_calificaciones_auxiliares.C15')
            ->get();
	}
}
