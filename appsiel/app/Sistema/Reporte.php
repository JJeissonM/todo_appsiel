...
class Reporte extends Model
{
	...
	public $encabezado_tabla = ['Aplicación', 'Descripción', 'Url Form Action' ,'Estado', 'Acción'];
	public static function consultar_registros()
	{
	    $registros = Reporte::leftJoin('sys_aplicaciones','sys_aplicaciones.id','=','sys_reportes.core_app_id')->select('sys_aplicaciones.descripcion AS campo1', 'sys_reportes.descripcion AS campo2', 'sys_reportes.url_form_action AS campo3', 'sys_reportes.estado AS campo4', 'sys_reportes.id AS campo5')
	    ->get()
	    ->toArray();
	    return $registros;
	}
