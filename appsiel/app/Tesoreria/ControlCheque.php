...
class ControlCheque extends Model
{
    ...
    public $encabezado_tabla = ['<i style="font-size: 20px;" class="fa fa-check-square-o"></i>','Fecha emisión', 'Tercero', 'Fuente', 'Fecha cobro', 'Número cheque', 'Referencia', 'Valor', 'Detalle', 'Doc. relacionado', 'Estado'];		
    ...
    public static function consultar_registros($nro_registros, $search)
    {
        return ControlCheque::leftJoin('core_tipos_docs_apps', 'core_tipos_docs_apps.id', '=', 'teso_control_cheques.core_tipo_doc_app_id_origen')
			            ...
			            ->select(
			            			...
			            			'teso_control_cheques.detalle AS campo8',
