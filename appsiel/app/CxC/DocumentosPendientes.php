...
class DocumentosPendientes extends Model
{
    ...
    public static function get_documentos_pendientes_clase_cliente($clase) {
        ...
        return DocumentosPendientes::leftJoin('core_terceros', 'core_terceros.id', '=', 'cxc_movimientos.core_tercero_id')
            ...
            ->select('cxc_movimientos.id', 'cxc_movimientos.core_tipo_transaccion_id', 'cxc_movimientos.core_tipo_doc_app_id',
                'cxc_movimientos.consecutivo', 'core_terceros.descripcion AS tercero', DB::raw($select_raw), 'cxc_movimientos.fecha',
                'cxc_movimientos.fecha_vencimiento', 'cxc_movimientos.valor_documento', 'cxc_movimientos.valor_pagado', 'cxc_movimientos.saldo_pendiente',
                'vtas_clientes.clase_cliente_id', 'cxc_movimientos.core_tercero_id')
            ->orderBy('cxc_movimientos.core_tercero_id')
            ->get()->toArray();
    }
