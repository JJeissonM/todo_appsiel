...
class CxcTransaccion
{
    ...
    public static function get_datos_tabla_ingreso_lineas_registros( $tipo_transaccion, $motivos )
    {
        ...
        $fila_controles_formulario .= '<td> 
                        ...
                        <td> '. Form::select('inv_motivo_id',$servicios,null,['id'=>'inv_motivo_id']) .' </td>
                        <td> '. Form::text('existencia_actual', null, ['disabled'=>'disabled','id'=>'existencia_actual','width'=>'15px']) .' </td>
                        <td> '. Form::text('precio_unitario', null, ['disabled'=>'disabled','id'=>'precio_unitario']) . Form::hidden('costo_unitario', null, ['disabled'=>'disabled','id'=>'costo_unitario']) .' </td>
