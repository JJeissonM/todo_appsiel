...
class CxcDocCruceEncabezado extends CxcDocEncabezado
{
    ...
    public $encabezado_tabla = ['Documento','Fecha','Valor Total','Tercero','Detalle','Acción'];
    ...
    {        
        ...
        $registros = CxcDocCruceEncabezado::leftJoin('core_tipos_docs_apps', 'core_tipos_docs_apps.id', '=', 'cxc_doc_encabezados.core_tipo_doc_app_id')
                    ...
                    ->select(DB::raw($select_raw),'cxc_doc_encabezados.fecha AS campo2','cxc_doc_encabezados.valor_total AS campo3','core_terceros.descripcion as campo4','cxc_doc_encabezados.descripcion AS campo5','cxc_doc_encabezados.id AS campo6')
                    ->get()
                    ->toArray();
