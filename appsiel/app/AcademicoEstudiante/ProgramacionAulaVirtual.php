    ...
    public static function consultar_registros($nro_registros, $search)
    {
        $collection = ProgramacionAulaVirtual::leftJoin('sga_cursos','sga_cursos.id','=','sga_programacion_aula_virtual.curso_id')
                                        ...
                                        ->select(
        										...
        										/*'sga_programacion_aula_virtual.curso_id',
        										'sga_programacion_aula_virtual.asignatura_id',
        										'sga_programacion_aula_virtual.actividad_escolar_id',
        										'sga_programacion_aula_virtual.guia_academica_id'*/)
