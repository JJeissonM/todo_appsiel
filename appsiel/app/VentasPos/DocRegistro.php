...
class DocRegistro extends Model
{
    ...
    protected $fillable = ['vtas_pos_doc_encabezado_id', 'vtas_motivo_id', 'inv_producto_id', 'inv_bodega_id', 'impuesto_id', 'precio_unitario', 'cantidad', 'precio_total', 'base_impuesto', 'tasa_impuesto', 'valor_impuesto', 'base_impuesto_total', 'tasa_descuento', 'valor_total_descuento', 'cantidad_devuelta', 'creado_por', 'modificado_por', 'estado'];
