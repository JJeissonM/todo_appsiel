...
class Tercero extends Model
{
    ...
    public $encabezado_tabla = ['<i style="font-size: 20px;" class="fa fa-check-square-o"></i>', 'Nom. Completo/Razón Social', 'Identificación', 'Descripción', 'Dirección', 'Teléfono', 'Estado'];
