...
{
    protected $fillable = ['core_app_id','descripcion','tipo','nota_mensaje',
    'maneja_firma_autorizada','maneja_curso','curso_predeterminado','maneja_periodo'
    ,'periodo_predeterminado','maneja_anio','maneja_estudiantes','plantilla'];

    public $encabezado_tabla = ['Aplicación','Nombre','Tipo','Nota/Mensaje','Maneja Firma Autotizada','Curso Predeterminado','Plantilla','Estado','Acción'];

    public static function consultar_registros()
    {    	
    	$registros = DifoFormato::leftJoin('sys_aplicaciones', 'sys_aplicaciones.id', '=', 'difo_formatos.core_app_id')
                    ->select('sys_aplicaciones.descripcion AS campo1',
