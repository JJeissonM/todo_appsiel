...
class AnalisisFuncional extends ModeloEavValor
{
	...
	protected $crud_model_id = 305; // Es el mismo $modelo_padre_id, la variable no se puede usar en métodos estáticos
    ...
    {
        $modelo_padre_id = 305; // AnalisisFuncional
        return AnalisisFuncional::leftJoin('sys_campos', 'sys_campos.id', '=', 'core_eav_valores.core_campo_id')
