...
class ExamenesVacunas extends ModeloEavValor
{
    ...
    public $vista_imprimir = 'consultorio_medico.salud_ocupacional.examenes_vacunas';

    public $vista_imprimir_aptitud = 'consultorio_medico.salud_ocupacional.examenes_vacunas_aptitud';

	public $encabezado_tabla = ['<i style="font-size: 20px;" class="fa fa-check-square-o"></i>', 'Campo', 'Valor'];

    public static function consultar_registros($nro_registros)
    {
        $modelo_padre_id = 286; // Exámenes / Vacunas
