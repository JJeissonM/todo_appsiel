...
class Estomatologico extends ModeloEavValor
{
	...
	protected $crud_model_id = 306; // Es el mismo $modelo_padre_id, la variable no se puede usar en métodos estáticos
    ...
    {
        $modelo_padre_id = 306; // Estomatologico
        return Estomatologico::leftJoin('sys_campos', 'sys_campos.id', '=', 'core_eav_valores.core_campo_id')
