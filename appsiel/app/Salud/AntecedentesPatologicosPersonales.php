...
class AntecedentesPatologicosPersonales extends ModeloEavValor
{
    ...
    public $vista_imprimir = 'consultorio_medico.salud_ocupacional.antecedentes_patologicos_personales';
