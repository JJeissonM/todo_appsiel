...
class RecomendacionLaboral extends Model
{
    ...
    protected $crud_model_id = 318; // Es el mismo $modelo_padre_id, a variable no se puede usar en métodos estáticos
    ...
    {
        $modelo_padre_id = 318; // Recomendaciones laborales
        return RecomendacionLaboral::leftJoin('sys_campos', 'sys_campos.id', '=', 'core_eav_valores.core_campo_id')
    ...
    {
        $modelo_padre_id = 318; // Recomendaciones laborales
        $string = RecomendacionLaboral::leftJoin('sys_campos', 'sys_campos.id', '=', 'core_eav_valores.core_campo_id')
            ->where('core_eav_valores.modelo_padre_id', $modelo_padre_id)
            ->select(
    ...
    {
        return "LISTADO DE Recomendaciones laborales";
    }
    ...
    {
        $modelo_padre_id = 318; // Recomendaciones laborales
        $opciones = RecomendacionLaboral::where('core_eav_valores.modelo_padre_id', $modelo_padre_id)
            ->orderBy('valor')
            ->get();
    ...
    public static function get_valor_to_show(array $campo)
    {
        ...
        return RecomendacionLaboral::where([
            ['modelo_padre_id','=',$arr_value[0]],
            ['registro_modelo_padre_id','=',$arr_value[1]],
            ['core_campo_id','=',$arr_value[3]]
            ])->value('valor');
    }
}
