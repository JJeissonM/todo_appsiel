...
<table class="datos1">
    ...
    <tr>
        ...
        ?>
        <td class="titulo">Nombre: </td> <td class="campo">{{ $estudiante->nombre1.' '.$estudiante->otros_nombres }}</td>
        <td class="titulo2">Fecha Nacimiento: </td> <td class="campo"> {{$estudiante->fecha_nacimiento}} </td>
    </tr>
    <tr>
        <td class="titulo"> Apellidos: </td><td class="campo">{{ $estudiante->apellido1 }} {{ $estudiante->apellido2 }} </td>
        <td class="titulo2"> Ciudad Nacimiento: </td><td class="campo"> {{$estudiante->ciudad_nacimiento}}</td>
    </tr>
    <tr>
        <td class="titulo"> Documento: </td><td class="campo"> {{ $estudiante->tipo_y_numero_documento_identidad }} </td>
        <td class="titulo2"> Edad:  </td><td class="campo"> <?php  echo calcular_edad($estudiante->fecha_nacimiento); ?> </td>
    </tr>
    <tr>
        <td class="titulo"> Dirección: </td><td class="campo"> {{ $estudiante->direccion1 }}, {{ $estudiante->barrio }} </td>
        <td class="titulo2">  Teléfono: </td><td class="campo"> {{ $estudiante->telefono1 }} </td>
    </tr>
    <tr>
...
<table class="datos1" style="table-layout:fixed;">
    <tr>
        <td colspan="4" align="center" style="background: #B1BECF;"> <b>Controles médicos</b></td>
    </tr>
    <tr>
        <td class="titulo2">Grupo sanguíneo: </td> <td class="campo" style="overflow: hidden;">{{ $estudiante->grupo_sanguineo }}</td>
        <td class="titulo2">Medicamento(s): </td> <td class="campo" style="overflow: hidden;">{{ $estudiante->medicamentos }}</td>
    </tr>
    <tr>
        <td class="titulo2"> Alergias: </td><td class="campo">{{ $estudiante->alergias }}</td>
        <td class="titulo2"> E.P.S.: </td><td class="campo">{{ $estudiante->eps }}</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td width="15px"><input type="checkbox" {{$requisitos[0]}}></td><td> Documento identidad</td>
        <td width="15px"><input type="checkbox" {{$requisitos[1]}}></td><td>Constancia SIMAT</td>
        <td width="15px"><input type="checkbox" {{$requisitos[2]}}></td><td>Fotos</td>
    </tr>
    <tr>
