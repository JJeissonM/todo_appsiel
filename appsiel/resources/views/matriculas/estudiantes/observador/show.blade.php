...
@section('content')
	...
	&nbsp;&nbsp;&nbsp;{{ Form::bsBtnPrint( 'matriculas/estudiantes/observador/imprimir_observador/'.$id . '?matricula_id=' . Input::get('matricula_id') ) }}
	...
	&nbsp;&nbsp;&nbsp;{{ Form::bsBtnEdit( 'matriculas/estudiantes/observador/valorar_aspectos/'.$id.'?id='.Input::get('id').'&id_modelo='.Input::get('id_modelo') . '&matricula_id=' . Input::get('matricula_id') ) }}
