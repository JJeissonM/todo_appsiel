<section id="portfolio">
    <div class="container">
        ...
        <div class="section-header">
            <h2 class="section-title text-center wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">Galeria de Imagenes</h2>
        ...
        <div class="text-center">
            <ul class="portfolio-filter">
                ...
                @if($cont <= 4) <li><a href="#" data-filter=".{{str_slug($album->titulo)}}">{{$album->titulo}}</a></li>
                    @else
                    @break
                    @endif
                    <?php $cont = $cont + 1; ?>
        ...
        <div class="portfolio-items isotope" style="position: relative; overflow: hidden; height: 260px;">
            ...
            <div class="portfolio-item {{str_slug($album->titulo)}} isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px);">
