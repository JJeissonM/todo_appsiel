@if($footer!=null)
<div class="footerarea" style="background-color: {{$footer->background}}; height: 600px;">
    <div class="container">
        <div class="row">
            ...
            <div class="contenido col-md-3 col-sm-12" style="margin: 20px 0;">
                <h5 class="column-title" style="color: white; font-size: 20px; font-weight: bold;">CONTACTENOS</h5>
            ...
            <div class="contenido col-md-3 col-sm-12" style="margin: 20px 0;">
                ...
                <aside class="" >
                    {!! str_replace('width="300"','width="250"',$footer->ubicacion)!!}
                </aside>
            </div><!--end .widget-column-2-->
        </div>
    </div><!--end .container-->
