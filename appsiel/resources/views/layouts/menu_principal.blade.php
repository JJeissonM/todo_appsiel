    ...
    <div style="position: absolute; display: flex; justify-content: center; align-items: center; width: 100%; height: 100%; z-index: 100; background-color: rgba(0, 0, 0, 0.37)">
        <div class="panel panel-danger" style="font-size: 22px">
            ...
            <div class="panel-body">
                Estimado/a Cliente, le recordamos que tiene un saldo vencido. Lo invitamos a poner su cuenta al día. Para más información escriba al +57 321 300 2639 <br> Su acceso ha sido bloqueado y este se normalizará al momento de pagar el total de la deuda.
            </div>
          </div>
    </div>	    
@endif
...
<div class="alert alert-danger alert-dismissible mora" role="alert">
    ...
    Estimado/a Cliente, le recordamos que tiene un saldo vencido. Lo invitamos a poner su cuenta al día. Para más información escríbanos al +57 321 300 2639
    <style>
        .navbar{
            margin-bottom: 0;
        }
