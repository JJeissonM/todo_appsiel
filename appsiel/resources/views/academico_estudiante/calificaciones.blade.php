            ...
            <div class="col-md-12" style="padding: 40px;">
                ...
                <div class="panel panel-default margin-bottom-30">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-8">
                                <h3 class="m-b-5">{{ $estudiante->nombre_completo }}</h3>
                                <p class="text-muted">
                                    Matrícula actual: <strong>{{ $codigo_matricula }}</strong> ·
                                    Curso actual: <strong>{{ $curso->descripcion }}</strong>
                                </p>
                            </div>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4 class="panel-title">Calificaciones por periodo</h4>
                    </div>
                    <div class="panel-body">
                        @if( $mensaje_facturas_vencidas->mensaje == '' )
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    {{ Form::label('periodo_id','Seleccionar periodo', ['class' => 'control-label']) }}
                                    {{ Form::select('periodo_id',$periodos,null,['class'=>'form-control','id'=>'periodo_id']) }}
                                </div>
                                <div class="col-sm-4">
                                    <p class="text-muted m-t-25">Elija el periodo para ver la libreta.</p>
                                </div>
                                <div class="col-sm-4 text-right">
                                    <label>&nbsp;</label>
                                    <a href="#" class="btn btn-success bt-detail btn-block" id="btn_generar"><i class="fa fa-play"></i> Consultar</a>
                                </div>
                            </div>
                            ...
                            <div class="well well-sm" id="resultado_consulta" style="min-height: 180px;">
