			...
			<tbody>
				...
				@foreach ($asignaturas as $fila)
					<tr>
							...
							<td>
								<a href="{{url('academico_estudiante/actividades_escolares/'.$curso_id.'/'.$fila->id.'?id='.Input::get('id'))}}" class="btn btn-sm btn-success"><i class="fa fa-edit"></i> Actividades escolares </a>
