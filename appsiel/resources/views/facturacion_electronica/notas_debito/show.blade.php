...
@section('botones_acciones')
    ...
    @if( $doc_encabezado->estado == 'Sin enviar' )
		<?php 
			$color = 'red';
		?>
		<a class="btn-gmail" href="{{ url( 'fe_nota_debito_enviar/' . $doc_encabezado->id . $variables_url ) }}" title="Enviar por correo" id="btn_email"><i class="fa fa-btn fa-envelope"></i></a>
	@endif
