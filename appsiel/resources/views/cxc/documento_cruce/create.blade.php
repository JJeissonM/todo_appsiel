		...
		$(document).ready(function(){
			...
			$('#btn_continuar1').click(function(event){
				...
				if ( validar_requeridos() ) {
						...
						var url = '../cxc/get_cartera_tercero/' + $('#core_tercero_id').val() + '/' + $('#fecha').val();
			...
			function validar_valor_aplicar(celda)
			{
				...
				// Se le agrega 1 (uno) porque el valor pendiente no tiene todos los decimales
