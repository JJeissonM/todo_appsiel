                    ...
                    <div class="toplink-static d-flex justify-content-center" style="/*width: auto;*/ height: 60px;">
                        <div style="position: absolute; z-index: 10;" >
                            <a href="{{ config('pagina_web.main_page_tienda_online') }}">
                                <img src="{{asset( config('configuracion.url_instancia_cliente').'storage/app/logos_empresas/'.$empresa->imagen)}}" style="z-index: 11000; height: 60px; width: {{config('configuracion.ancho_logo_formatos')}}px;"> 
                            </a>                                  
                        </div>                                                     
                    </div>
