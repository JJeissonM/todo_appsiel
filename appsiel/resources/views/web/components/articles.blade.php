                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="formato">
                                                    @if($articles->formato=='LISTA')
                                                        <option selected value="LISTA">ARTÍCULOS EN FORMATO DE LISTA
                                                        </option>
                                                        <option value="BLOG">ARTÍCULOS EN FORMATO DE BLOG</option>
                                                    @else
                                                        <option value="LISTA">ARTÍCULOS EN FORMATO DE LISTA</option>
                                                        <option selected value="BLOG">ARTÍCULOS EN FORMATO DE BLOG
                                                        </option>
                                                    @endif
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="orden">
                                                    ...
                                                    @else
                                                        ...
                                                        <option selected value="DESC">MOSTRAR LOS MAS RECIENTES
                                                            PRIMERO
                                                        </option>
                                                    @endif
                                                </select>
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="card-body">
                                    ...
                                    @if($articles != null)
                                        ...
                                        @else
                                            <p style="color: red;"><i class="fa fa-warning"></i> Antes de añadir
                                                artículos debe configurar la sección.</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                            ...
                                            @if(count($articles->articles)>0)
                                                @foreach($articles->articles as $a)
                                                    <div class="col-md-12 article-ls"
                                                         style="line-height: 5px; margin-bottom: 20px;">
                                                        <div class="media service-box"
                                                            ...
                                                            <div id="{{$a->id}}" data-toggle="modal"
                                                                 ...
                                                                 data-placement="top" title="Editar Artículo">
                                                                <i style="cursor: pointer;" class="fa fa-edit"></i>
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 style="font-size: 14px;"
                                                                    class="media-heading">{{$a->titulo}}</h6>
                                                                <p>{{"Estado: ".$a->estado}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--/.col-md-4-->@endforeach
                                            @else
                                                <p style="color: red;"><i class="fa fa-warning"></i> No hay artículos
                                                    publicados en ésta sección...</p>
                                            @endif
                                        @endif
                                    </div>
                                </div>
