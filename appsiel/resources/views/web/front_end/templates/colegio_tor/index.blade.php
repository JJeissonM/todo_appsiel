...
<html lang="es">
  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class="container-fluid contenido">
      ...
      @include('web.front_end.modulos.menu.index', ['clase_fixed' => 'navbar-fixed-top', 'mostar_logo' => true,'url_logo' => asset( config('configuracion.url_instancia_cliente').'/storage/app/pagina_web/'.$pagina->logo), 'slogan' => $empresa->descripcion, 'alineacion_items' => 'navbar-right'])

      @include('web.front_end.modulos.banner.zindex_escudo_menu')
