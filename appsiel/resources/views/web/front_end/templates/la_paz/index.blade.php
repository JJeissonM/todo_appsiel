...
<html lang="es">
  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class="container-fluid contenido">
      ...
      @include('web.front_end.modulos.banner.top_escudo_redes')

      @include('web.front_end.modulos.menu.index')

      @include('web.front_end.modulos.carousel.index',['datos'=> $datos_carousel])
      
      <br>

      @include('web.front_end.modulos.articulos_destacados.index')
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6 anuncios">
            @include('web.front_end.modulos.anuncios.index',['id'=>1])
          </div>
    ...
    <div id="contact" class="container-fluid">
      <div class="row">
        <div class="col-sm-5">
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              ...
              @include('web.front_end.modulos.contactenos.index')
            </div>
        ...
        <div class="col-sm-7" id="ubicacion">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d980.8146268589153!2d-73.2563727!3d10.4802762!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x48c24a4530d111b9!2sColegio+La+Paz!5e0!3m2!1ses-419!2sco!4v1562249088229!5m2!1ses-419!2sco" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
      </div>
    </div>

    <footer class="container-fluid" style="background-color: #264d8e; color: white;">
      <hr>
      <div class="row">
        <div class="col-sm-3">
