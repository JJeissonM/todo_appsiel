    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 wow fadeInLeft">
                <img class="img-responsive" src="{{asset('images/main-feature.png')}}" alt="">
            </div>
            <div class="col-sm-6">
...
<section id="cta2">
    <div class="container">
        <div class="text-center">
            ...
            <img class="img-responsive wow fadeIn" src="{{asset('images/cta2/cta2-img.png')}}" alt="" data-wow-duration="300ms" data-wow-delay="300ms">
        </div>
    </div>
</section>
            ...
            <div class="portfolio-item creative">
                <div class="portfolio-item-inner">
                    ...
                    <div class="portfolio-info">
                        ...
                        <a class="preview" href="{{asset('images/portfolio/full.jpg')}}" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                    </div>
                </div>
            </div><!--/.portfolio-item-->
                ...
                <div id="carousel-testimonial" class="carousel slide text-center" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <p><img class="img-circle img-thumbnail" src="{{asset('images/testimonial/01.jpg')}}" alt=""></p>
        ...
        <div class="row">
                    ...
                    <article>
                        <header class="entry-header">
                            <div class="entry-thumbnail">
                                <img class="img-responsive" src="{{asset('images/blog/01.jpg')}}" alt="">
            ...
            <div class="col-sm-6">
                <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
                    <article class="media clearfix">
                        <div class="entry-thumbnail pull-left">
                            <img class="img-responsive" src="{{asset('images/blog/02.jpg')}}" alt="">
                ...
                <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="200ms">
                    <article class="media clearfix">
                        <div class="entry-thumbnail pull-left">
                            <img class="img-responsive" src="{{asset('images/blog/03.jpg')}}" alt="">
