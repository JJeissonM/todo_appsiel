...
<body>
    ...
    @else
        ...
        <h4 style="width: 100%; text-align:center;"> Resúmen Diario de Ventas</h4>

        <table class="table tabla_registros" style="margin-top: 12px !important; font-size: {{ $tamanino_fuente_2 }};" width="100%">
            <tr style="font-size: 1.1em;">
                <td>
                    <b>Desde:</b>  {{ $fecha_desde }}
                </td>
                <td>
