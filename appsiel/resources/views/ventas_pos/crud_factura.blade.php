        ...
        <div class="marco_formulario">
            ...
            @if( Input::get('action') == 'edit' )
                ...
                <div class="row" style="margin: 5px 0;">
                    <a href="{{ url('pos_factura/create?id=' . Input::get('id') . '&id_modelo=' . Input::get('id_modelo') . '&id_transaccion=' . Input::get('id_transaccion') . '&pdv_id=' . $pdv_id_cancelar . '&action=create') }}"
