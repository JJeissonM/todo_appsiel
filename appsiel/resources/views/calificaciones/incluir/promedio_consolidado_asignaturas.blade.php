    ...
    <tbody>
            ...
            @foreach($estudiantes as $estudiante)
                ...
                <tr class="fila-{{$i}}" >
                        ...
                        for($j=0; $j < $cantidad_asignaturas_mostrar; $j++)
                        {
                            ...
                            foreach($periodos as $periodo)
                            {
                                ...
                                if ( !is_null($cali) ) 
                                {
                                    ...
                                    $cali_periodos_listos[$periodos_listos]['text'] = number_format($cali->calificacion, 1, ',', '.');
                            ...
                            $cali_faltante_text =number_format($cali_faltante, 0, ',', '.');
                    ...
                    @endphp
                        <td>
                            <span style="color: {{ $color }}"> {{ number_format( $prom, 1, ',', '.') }} </span>
                        </td>    
                    @php
