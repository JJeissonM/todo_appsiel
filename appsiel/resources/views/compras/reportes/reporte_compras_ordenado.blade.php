...
<?php 
    switch ( $agrupar_por )
    {
        ...
        case 'clase_proveedor_id':
            $primer_encabezado = 'Clases de Proveedores';
            break;
        ...
        <tbody>
            ...
            <?php
                ...
                foreach( $movimiento as $campo_agrupado => $coleccion_movimiento)
                {
                    ...
                    $base_impuesto = $coleccion_movimiento->sum('base_impuesto');
                    ...
                    if($detalla_productos)
                    {
                        ...
                        foreach( $items AS $item )
                        {
                            ...
                            if ( $iva_incluido )
                            {
                                ...
                                $precio_item = $item->sum('base_impuesto');
                            }
