...
@section('botones_anterior_siguiente')
	{!! $botones_anterior_siguiente->dibujar( 'compras/', $variables_url.'&vista=compras.notas_credito.show' ) !!}
@endsection
...
@section('div_advertencia_anulacion')
	<div class="alert alert-warning" style="display: none;">
		...
		<br>
		<?php 
			$url = 'compras_notas_credito_anular'; // NC con base en factura
			if( $id_transaccion == 40 )
			{
				$url = 'compras_notas_credito_directa_anular';
			}
		?>
