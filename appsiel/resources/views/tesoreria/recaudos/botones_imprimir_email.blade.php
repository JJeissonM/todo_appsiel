...
<div>
    ...
    {{ Form::bsBtnPrint( 'tesoreria/recaudos_imprimir/'.$id.$variables_url.'&formato_impresion_id=' . $default_key ) }}
    {{ Form::bsBtnEmail( 'teso_recaudo_enviar_por_email/'.$id.$variables_url.'&formato_impresion_id=' . $default_key ) }}
</div>