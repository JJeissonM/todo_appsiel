        ...
        <div class="container-fluid">
            <div class="marco_formulario">
                <div class="container">
                            ...
                            <tr>
                                ...
                                <td style="border: solid 1px #ddd;">
                                    ...
                                    @if(\App\Tesoreria\TesoMovimiento::usarMovimientosTesoreriaPorHora())
                                        <b>Apertura turno:</b> {{ \App\Support\ReportTimeFormatter::dateTime($registro->fecha_hora_apertura, 'No registrada') }}
                                        <br/>
                                        <b>Cierre turno:</b> {{ \App\Support\ReportTimeFormatter::dateTime($registro->fecha_hora_cierre, 'No registrado') }}
                                        <br/>
                                    @endif
                                    <b>Realización: &nbsp;&nbsp;</b> {{ \App\Support\ReportTimeFormatter::dateTime($registro->created_at) }}
                                    <br/>
                                </td>
                            </tr>
                        </table>
                    ...
                    @include('tesoreria.arqueo_caja.movimiento_cuentas_bancarias')
