			...
			<div class="row">
				<div class="col-md-12">
					...
					<button class="btn btn-primary" id="btn_cargar_documentos_pendientes">
						<i class="fa fa-level-up"></i> Ver Facturas de CxC
					</button>
					{{ Form::Spin(48) }}
					...
					<br><br>
					<input type="hidden" name="input_total_valor_documentos_cartera" id="input_total_valor_documentos_cartera" value="0">
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){			
		    ...
		    $(document).on('click','#btn_cargar_documentos_pendientes', function(){
		    	...
		    	$.fn.actualizar_total_resumen_operaciones( parseFloat( $('#input_total_valor_documentos_cartera').val() * -1 ) );
		    });
