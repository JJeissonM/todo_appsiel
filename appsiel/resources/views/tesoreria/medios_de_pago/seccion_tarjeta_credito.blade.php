...
<div class="row">
	<div class="col-md-12">
		<div class="container-fluid" style="display: block; border: 1px solid #ddd; border-radius: 4px;">
			...
			<h5 class="text-center">Registros de pagos por Tarjeta Débito</h5>
			<hr>
				...
				<div class="col-md-6" >
					<div style="border-radius: 4px; border: solid 1px #848484; padding: 5px;">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="row" style="padding:5px;">
									{{ Form::bsSelect('tipo_operacion_id_tarjeta_credito', null, 'Tipo Ope', $tipos_operaciones, []) }}
								</div>
							</div>
							<div class="col-md-6">
								<div class="row" style="padding:5px;">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row" style="padding:5px;">
									{{ Form::bsText( 'numero_comprobante_tarjeta_credito', null, 'N° Comp', []) }}
								</div>
							</div>
						</div>
						<div class="row">
