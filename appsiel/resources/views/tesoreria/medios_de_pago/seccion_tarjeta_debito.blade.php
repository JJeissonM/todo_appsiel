				...
				<div class="col-md-6" >
					<div style="border-radius: 4px; border: solid 1px #848484; padding: 5px;">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="row" style="padding:5px;">
									{{ Form::bsSelect('tipo_operacion_id_tarjeta_debito', null, 'Tipo de operación', [''=>'','Recaudo cartera'=>'Recaudo cartera (CxC)','Anticipo'=>'Anticipo cliente (CxC a favor)','Otros recaudos'=>'Otros recaudos','Prestamo financiero'=>'Prestamo financiero (CxP)'], []) }}
								</div>
							</div>
							<div class="col-md-6">
								<div class="row" style="padding:5px;">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row" style="padding:5px;">
									{{ Form::bsText( 'numero_comprobante_tarjeta_debito', null, 'Núm. comprobante', []) }}
								</div>
							</div>
						</div>
						<div class="row">
