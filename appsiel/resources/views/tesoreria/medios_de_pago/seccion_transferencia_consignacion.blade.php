						...
						<div class="row">
							<div class="col-md-6">
								<div class="row" style="padding:5px;">
									{{ Form::bsSelect('tipo_operacion_id_transferencia_consignacion', null, 'Tipo de operación', [''=>'','Recaudo cartera'=>'Recaudo cartera (CxC)','Anticipo'=>'Anticipo cliente (CxC a favor)','Otros recaudos'=>'Otros recaudos','Prestamo financiero'=>'Prestamo financiero (CxP)'], []) }}
								</div>
							</div>
							<div class="col-md-6">
								<div class="row" style="padding:5px;">
