...
<body>
    ...
    @for($i=0;$i<$cantidad_periodos;$i++)
        ...
        <table style="margin: 30px 15px 0px 35px;">
            <tr>
                <td>
                    @include('tesoreria.incluir.pension_tres_columnas',['etiqueta'=>'Copia Estudiante'])
                </td>
                <td>
                    @include('tesoreria.incluir.pension_tres_columnas',['etiqueta'=>'Copia Colegio'])
                </td>
                <td>
                    @include('tesoreria.incluir.pension_tres_columnas',['etiqueta'=>'Copia BANCO'])
                </td>
            </tr>
        </table>
        <div class="page-break"></div>
