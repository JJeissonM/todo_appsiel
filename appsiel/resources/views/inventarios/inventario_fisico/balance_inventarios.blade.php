        ...
        <td style="border: none;">
            <div class="headdoc">
                ...
                @if( !empty($datos_balance['turno']) )
                    <b>Apertura turno:</b> {{ \App\Support\ReportTimeFormatter::dateTime($datos_balance['turno']['opening_at']) }}
                    <br/>
                    <b>Cierre turno:</b> {{ \App\Support\ReportTimeFormatter::dateTime($datos_balance['turno']['closing_at']) }}
                    <br/>
                @endif
