...
@section('botones_acciones')
    ...
    <button type="button" class="btn-gmail" data-toggle="modal" data-target="#modal_unificar_lineas" title="Unificar ítems repetidos">
        <i class="fa fa-compress"></i>
    </button>
@endsection

@section('section_after_documento_vista')
    <div class="modal fade" id="modal_unificar_lineas" tabindex="-1" role="dialog" aria-labelledby="modal_unificar_lineas_label">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="modal_unificar_lineas_label">Unificar ítems repetidos</h4>
                </div>
                <div class="modal-body">
                    Esta acción sumará las cantidades y costos de ítems repetidos y dejará una sola línea por producto.
                    ¿Deseas continuar?
                </div>
