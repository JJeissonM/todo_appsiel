	...
	<div class="container-fluid">
		<div class="marco_formulario">
		    ...
		    <span class="well well-sm pull-right">
		    	<i class="fa">Modo:</i> &nbsp;&nbsp;&nbsp;
		    	<label class="radio-inline" title="Código numérico"><input type="radio" name="modo_ingreso" value="numerico" checked><i class="fa">123</i></label>
				<label class="radio-inline" title="Código de barras"><input type="radio" name="modo_ingreso" value="barras"><i class="fa fa-barcode"></i></label>
				<label class="radio-inline" title="Texto"><input type="radio" name="modo_ingreso" value="texto"><i class="fa">abc</i></label>
		    </span>
		    <table class="table table-striped" id="ingreso_productos">
		        <thead>
		            <tr>
		                <th data-override="inv_producto_id" style="display: none;"></th>
		                <th data-override="motivo_id" style="display: none;"></th>
		        ...
		        <tbody>
		        	<tr id="fila_base"><!-- -->
	                    ...
	                    <td> {{ Form::text('costo_unitario', null, [ 'id' => 'costo_unitario', 'class' => 'form-control' ] ) }} </td>
	                    <td> {{ Form::text('cantidad', null, [ 'id' => 'cantidad', 'class' => 'form-control' ] ) }} </td>
	                    <td> {{ Form::text('costo_total', null, [ 'id' => 'costo_total', 'class' => 'form-control' ] ) }} </td>
	                    <td>
	                    	<button type='button' class='btn btn-danger btn-xs btn_eliminar'><i class='glyphicon glyphicon-trash'></i></button>
	                    	<button type='button' class='btn btn-success btn-xs btn_confirmar'><i class='glyphicon glyphicon-ok'></i></button>
	                    </td>
	                </tr>
		        </tbody>
		        <tfoot>
		            ...
		            <tr>
		                <td colspan="8">
		                	<button type="button" style="background-color: transparent; color: #3394FF; border: none;display:none;" id="btn_nueva_linea"><i class="fa fa-btn fa-plus"></i> Agregar registro</button>

		                	<!-- Trigger the modal with a button -->
							<button type="button" class="btn btn-info btn-xs" id="btn_nuevo" style=""><i class="fa fa-btn fa-plus"></i></button>
...
@section('scripts')
	...
	<!-- <script src="{ {asset('assets/js/inventarios/jscript.js')}}"></script> -->
