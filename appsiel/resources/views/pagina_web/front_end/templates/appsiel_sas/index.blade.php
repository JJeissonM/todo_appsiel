...
@include('pagina_web.secciones.menu_principal')
<br>
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="{{ asset('assets/img/pagina_web/banner1.png') }}" alt="appsiel" class="img-responsive" style="max-height: 500px;" width="100%">      
      </div>
  ...
  <div class="row slideanim">
    ...
    <div class="col-sm-8 col-xs-12">
        ...
        @foreach ($app as $fila)
          ...
          @include('pagina_web.secciones.dibujar_icono_app')
        ...
        @for($j=0; $j < ( ($i % $cant_cols) - 1);$j++)
          @include('pagina_web.secciones.dibujar_icono_vacio')
        @endfor
    </div>
...
@include('pagina_web.front_end.modulos.clientes.index')
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    ...
    @include('pagina_web.scripts.php.formulario_contactenos')
  </div>
</div>

@include('pagina_web.front_end.modulos.preguntas_frecuentes.index')
