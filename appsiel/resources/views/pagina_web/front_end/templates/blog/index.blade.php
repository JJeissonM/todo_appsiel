...
<html lang="es">
  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class="container-fluid contenido">
      ...
      @include('pagina_web.front_end.modulos.menu.index', ['clase_fixed' => 'navbar-fixed-top', 'mostar_logo' => true,'url_logo' => asset( config('configuracion.url_instancia_cliente').'/storage/app/pagina_web/'.$pagina->logo), 'slogan' => $empresa->descripcion, 'clase_alineacion_texto' => 'navbar-right'])
      ...
      <hr>
        @if( $galeria_imagenes )
          @include('pagina_web.front_end.modulos.galeria_imagenes.index')
        @else
          @include('pagina_web.front_end.templates.blog.articulos')
        @endif
      </div> 
