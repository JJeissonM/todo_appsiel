			...
			<table class="table table-bordered table-striped">
				<tbody>
					<tr>
						...
						<td class="border" style="width: 40%;"><img style="width: 220px; height: 70px;" src="{{ asset( config('configuracion.url_instancia_cliente') ).'/storage/app/logos_empresas/'.$empresa->imagen }}"></td>
					</tr>
				</tbody>
			</table>
			<div class="row">
			...
			<table style="width: 100%;">
				<tbody>
					...
					<tr>
						...
						<td class="border" style="width: 19%; font-weight: bold; font-size: 12px;">@if(isset($conductores[1])) @if($conductores[1]->licencia!=null) {{$conductores[1]->licencia->nro_documento}} @endif @endif</td>
						<td class="border" style="width: 10%; font-weight: bold; font-size: 12px;">@if(isset($conductores[1])) @if($conductores[1]->licencia!=null) {{$conductores[1]->licencia->vigencia_fin}} @endif @endif</td>
					</tr>
					<tr>
						...
						<td class="border" style="width: 19%; font-weight: bold; font-size: 12px;">@if(isset($conductores[2])) @if($conductores[2]->licencia!=null) {{$conductores[2]->licencia->nro_documento}} @endif @endif</td>
						<td class="border" style="width: 10%; font-weight: bold; font-size: 12px;">@if(isset($conductores[2])) @if($conductores[2]->licencia!=null) {{$conductores[2]->licencia->vigencia_fin}} @endif @endif</td>
					</tr>
					<tr>
						<td class="border" style="width: 15%; font-weight: bold; font-size: 12px; border-bottom: none;"></td>
						<td class="border" style="width: 32%; font-weight: bold; font-size: 12px;">NOMBRES Y APELLIDOS</td>
