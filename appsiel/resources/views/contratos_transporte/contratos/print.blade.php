			...
			<table style="width: 100%; font-size: 11px;">
				<tbody>
					...
					<tr>
						...
						<td style="width: 40%; text-align: left;"><img src="{{config('contratos_transporte.url_imagen_firma_y_sello_empresa')}}" style="max-height: 70px;"></td>
					</tr>
					<tr>
