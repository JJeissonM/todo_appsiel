...
{{ Form::open( [ 'url' => 'core/eliminar_registros_eav?id='.$id_app.'&id_modelo='.$id_modelo, 'style' => 'display:inline;', 'class' => 'form_eliminar' ] ) }}
	...
	<button class="btn btn-danger btn-xs btn-detail btn_eliminar_datos_modelo" title="Eliminar" data-descripcion_modelo="{{ $lbl_descripcion_modelo_entidad }}"> <i class="fa fa-trash"></i> &nbsp; </button>
{{ Form::close() }}