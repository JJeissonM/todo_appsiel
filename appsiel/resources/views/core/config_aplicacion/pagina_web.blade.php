				...
				<div class="row">
					<div class="col-md-6">
						<div class="row" style="padding:5px;">
							...
							?>
							{{ Form::bsText('main_page_tienda_online', $main_page_tienda_online, 'Pagina principal tienda online', [], ['class'=>'form-control']) }}
						</div>
					</div>
					<div class="col-md-6">
						<div class="row" style="padding:5px;">
							...
							?>
							{{ Form::bsText('public_key_wompi', $public_key_wompi, 'Llave publica pasarela de pago Wompi', [], ['class'=>'form-control']) }}
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="row" style="padding:5px;">
							<?php
							if( isset($parametros['tyc_page_tienda_online'] ) )
							{
								$main_page_tienda_online = $parametros['tyc_page_tienda_online'];
							}else{
								$main_page_tienda_online = 'http://localhost/todo_appsiel/sitio-tienda-online';
							}
							?>
