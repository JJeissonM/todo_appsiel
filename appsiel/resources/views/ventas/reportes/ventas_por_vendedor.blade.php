        ...
        <tbody>
            ...
            <?php
                ...
                foreach( $movimiento as $campo_agrupado => $coleccion_movimiento)
                {
                    ...
                    $vendedor = App\Ventas\Vendedor::find($campo_agrupado);
                    $descripcion_vendedor = 'Vendedor no asignado ID vendedor=' . $campo_agrupado;
                    if ($vendedor != null) {
                        $descripcion_vendedor = 'Error. Tercero de vendedor no asignado ID vendedor=' . $campo_agrupado;
                        if ($vendedor->tercero != null) {
                            $descripcion_vendedor = $vendedor->tercero->descripcion;
                        }                        
                    }
                    $array_lista[$i]['descripcion'] = $descripcion_vendedor;
