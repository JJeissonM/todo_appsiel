        	...
        	@foreach( $datos as $linea_empleado )
                <tr>
                    ...
                    <td>{{ $linea_empleado->tipo_documento }}</td>
                     ...
                     <td>{{ number_format( $linea_empleado->pagos_salarios, 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_emolumentos_eclesiasticos, 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_honorarios , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_servicios , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_comisiones , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_prestaciones_sociales , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_viaticos , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_gastos_representacion , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_trabajo_cooperativo , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_otros_pagos , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_cesantias_e_intereses_pagadas  , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_pensiones_jubilacion , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->total_ingresos_brutos, 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->aportes_salud_obligatoria , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->aportes_pension_obligatoria_y_fsp , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->aportes_voluntarios_pension , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->aportes_afc, 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->aportes_avc, 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->valores_retefuente , 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_bonos, 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_desde_recursos_publicos_para_educacion, 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_alimentacion_mayores_41uvt, 0, ',', '.') }}</td>
                     <td>{{ number_format( $linea_empleado->pagos_alimentacion_hasta_41uvt, 0, ',', '.') }}</td>
