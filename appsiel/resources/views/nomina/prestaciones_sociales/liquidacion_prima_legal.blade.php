<div class="marco_formulario">
	<div class="container-fluid">
		...
		<h4 style="width: 100%;text-align: center;">
			<strong>Liquidación de Prima de Servicios</strong>
		</h4>
		...
		<table class="table">
			<tbody>
				...
				<tr>
					...
					<td><strong>Días prima de servicios: </strong> {{ number_format( $tabla_resumen['dias_totales_liquidacion'],2,',','.' ) }} </td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
				</tr>
				<tr>
					<td colspan="3"><strong>Total prima de servicios: </strong> ${{ number_format( $tabla_resumen['valor_total_liquidacion'],'0',',','.' ) }} </td>
				</tr>
			</tbody>
		</table>
	</div>
