...
@section( 'titulo', 'Contabilización de planilla integrada' )

@section('detalles')
	<p>
		Este proceso genera los registros contables de los registros de la planilla integrada basandose en las cuentas Débito y Crédito asignadas en los Datos de configuración de la empresa para la PILA.
	</p>
	<br>
	<span class="text-info"> El proceso Genera un documento de contabilidad (Nota contable). </span>
	<br><br>
	<span class="text-danger"> Advertencia!!!. Antes de almacenar los registros, valide que aún no se haya contabilizado la planilla del mes.</span>
@endsection
