...
<script type="text/javascript" src="<?php echo e(asset('assets/web/js/jquery.filterizr.min.js')); ?>"></script>
<!-- Gallery Lightbox -->
<script type="text/javascript" src="<?php echo e(asset('assets/web/js/jquery.magnific-popup.min.js')); ?>"></script>
<!-- Counter js -->
<script type="text/javascript" src="<?php echo e(asset('assets/web/js/counter.js')); ?>"></script>
<!-- Ajax contact form  -->
<script type="text/javascript" src="<?php echo e(asset('assets/web/js/app.js')); ?>"></script>

<!-- Custom js -->
<script type="text/javascript" src="<?php echo e(asset('assets/web/js/custom.js')); ?>"></script>
