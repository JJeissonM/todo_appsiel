...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-body d-flex justify-content-between flex-wrap" >
            <div id="wrapper">
                <div class="contenido">
                    <img src="<?php echo e(asset('img/img-1.jpg')); ?>" alt="" class="imagen">
                ...
                <div class="contenido">
                    <img src="<?php echo e(asset('img/img-2.jpg')); ?>" alt="" class="imagen">
                    <div class="descripcion">
                        <h5 class="titulo">Maratón de programación</h5>
                        <p>Lorem ipsum dolor sit amet.</p>
                    </div>
                ...
                <div class="contenido">
                    <img src="<?php echo e(asset('img/img-3.jpg')); ?>" alt="" class="imagen">
                    <div class="descripcion">
                        <h5 class="titulo">Maratón de programación</h5>
                        <p>Lorem ipsum dolor sit amet.</p>
                    </div>
                ...
                <div class="add d-flex justify-content-end">
                    <a href="<?php echo e(url('slider/create').'/'.$widget.$variables_url); ?>"> Agregar Item</a>
                </div>
            </div>
            <div class="widgets" id="widgets">
                <?php echo Form::slider(""); ?>
