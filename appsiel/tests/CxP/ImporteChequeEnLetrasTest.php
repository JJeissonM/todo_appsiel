...
class ImporteChequeEnLetrasTest extends PHPUnit_Framework_TestCase
{
    ...
    public function importes()
    {
        return [
            ...
            ['999999999.99', 'NOVECIENTOS NOVENTA Y NUEVE MILLONES NOVECIENTOS NOVENTA Y NUEVE MIL NOVECIENTOS NOVENTA Y NUEVE PESOS CON NOVENTA Y NUEVE CENTAVOS'],
            ['1000000000', 'MIL MILLONES DE PESOS'],
            ['1000000001', 'MIL MILLONES UN PESOS'],
            ['1001000000', 'MIL UN MILLONES DE PESOS'],
            ['1234567890.50', 'MIL DOSCIENTOS TREINTA Y CUATRO MILLONES QUINIENTOS SESENTA Y SIETE MIL OCHOCIENTOS NOVENTA PESOS CON CINCUENTA CENTAVOS'],
            ['2000000000.01', 'DOS MIL MILLONES DE PESOS CON UN CENTAVO'],
    ...
    {
        return [[-1], ['texto'], [null], [INF], [NAN], ['1000000000000']];
    }
}
