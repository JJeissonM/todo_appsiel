...
class MovimientosCxcReportTest extends TestCase
{
    public function test_ordena_facturas_y_recaudos_y_calcula_el_saldo_acumulado()
    {
        $data = collect([
            $this->linea('2026-08-20', 'Recaudo', 0, 300, '2026-08-20 10:00:00', 2, 8),
        ...
        $resultado = (new ReportesController())
            ->ordenar_y_calcular_saldos_cxc($data);

        $this->assertSame(
            ['Saldo anterior', 'Factura', 'Recaudo'],
    ...
    public function test_desempata_por_tipo_e_id_si_comparten_fecha_y_hora()
    {
        $momento = '2026-08-20 09:00:00';
        $data = collect([
            $this->linea('2026-08-20', 'Recaudo', 0, 100, $momento, 2, 1),
