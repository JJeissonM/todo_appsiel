...
class TesoreriaRecaudosPermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        $permission = Permission::firstOrNew([
            'name' => 'teso_anular_recaudo_general'
        ]);

        $permission->core_app_id = $coreAppId;
        $permission->modelo_id = 46;
        $permission->descripcion = 'Anular recaudo general';
        $permission->url = 'tesoreria/recaudos_anular/id_fila';
        $permission->parent = 0;
        $permission->orden = 0;
